...
export default function FacialExpression({ setSongs }) {
    ...
    return (
        <div className='mood-element' >
            ...
            <div>
                <p className="heading">Live Mood Detection</p>
                <p className='description'>Your current mood is being analysed in real-time.Enjoy music tailored to your feelings.</p>
